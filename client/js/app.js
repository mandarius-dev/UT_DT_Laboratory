var app = new Vue({
    ...
    methods: {
        ...
        encode: function(bits){
            ...
            var c0 = this.parity(c1+c2+c4+c8+parseInt(bits[0].data)+parseInt(bits[1].data)+parseInt(bits[2].data)+parseInt(bits[3].data)+parseInt(bits[4].data)+parseInt(bits[5].data)+parseInt(bits[6].data)+parseInt(bits[7].data));
